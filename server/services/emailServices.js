...
import sendEmail from "./sendgrid.js"; // this is for sendgrid api to send email. acccount creation is rejected by brevo. So, I have to use resend api to send email.
